  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: 'linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(12,14,25,1) 100%)'
      }}
    >
      <div className={id === 6 ? 'flex justify-center h-full' : ''}>
        ...
        <div className={cn(
          ...
          <div className='font-sans font-extralight text-[#c1c2d3] text-sm md:text-xs lg:text-base x-10'>
            {description}
          </div>
